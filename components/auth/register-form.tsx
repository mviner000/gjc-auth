        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="mt-[-10px]">
         ...
         <Button type="submit" className="w-full mt-3" disabled={isPending}>
          ...
          <div className="space-y-1 mt-2 mb-[-10px]">
            ...
            <p className="text-xs font-normal">
            By clicking Sign Up, you agree to our <a className="text-blue-700 cursor-pointer no-underline hover:underline">Terms, Privacy Policy</a> and <a className="text-blue-700 cursor-pointer no-underline hover:underline">Cookie Policy</a>. You may receive Email Notifications from us and can opt out any time.
            </p>
          </div>
        </form>
      </Form>
